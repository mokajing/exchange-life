...
,
  ...
  // === Auto-generated fallback entries for missing BGM tags (2026-06-28) ===
  african_drums_soft: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  ambient_dawn_birds: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  ambient_nature: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  ambient_space: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  ancient_connection: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  ancient_sorrow: { file: 'audio/bgm/melancholic.mp3', volume: 0.35, loop: true },
  andean_flute_morning: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  apprentice_silence_tension: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  arctic_wind: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  awkward_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  bathroom_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  blizzard_drive: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  blizzard_white_noise: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  bowl_resonance: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  business_clarity: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  campus_afternoon_piano: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  campus_folk_guitar: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  candle_lullaby: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  celebration_orchestra: { file: 'audio/bgm/epic_landscape.mp3', volume: 0.45, loop: true },
  cello_memory: { file: 'audio/bgm/bittersweet.mp3', volume: 0.35, loop: true },
  childhood_echo_fade: { file: 'audio/bgm/bittersweet.mp3', volume: 0.35, loop: true },
  children_humming: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  classroom_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  confusion_fog: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  cotton_wrapped_love: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  council_humming: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  courage_dawn: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  creative_flow: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  crossroads_wind_pause: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  daily_ambient_soft: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  dark_ambient: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  dawn_birds: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  dawn_breath: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  dawn_chant: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  dawn_hope: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  dawn_hope_andean: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  dawn_peace: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  dawn_warmth_piano: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  desert_imzad: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  determined_rhythm: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  digital_glitch_alert: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  dinner_table_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  discovery_chime: { file: 'audio/bgm/emotional_buildup.mp3', volume: 0.4, loop: true },
  discovery_moment: { file: 'audio/bgm/emotional_buildup.mp3', volume: 0.4, loop: true },
  dramatic_buildup: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  drums_of_warning: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  empty_desk: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  empty_room: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  empty_station_wind: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  epic_orchestral: { file: 'audio/bgm/epic_landscape.mp3', volume: 0.45, loop: true },
  evening_news_ambient: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  evening_rain_solitude: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  eviction_drums: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  fading_tradition_bell: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  family_evening_gentle: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  ...
  forge_fire: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  gentle_comfort: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  gentle_piano_memory: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  grandma_touch_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  guqin_chant: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  guqin_memory: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  heart_pause: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  heartbeat: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  heartbeat_alarm: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  heartbeat_tension: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  heartbreak_violin: { file: 'audio/bgm/melancholic.mp3', volume: 0.35, loop: true },
  hope_guitar: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  hope_piano: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  hopeful: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  hopeful_moment: { file: 'audio/bgm/emotional_buildup.mp3', volume: 0.4, loop: true },
  hopeful_strings: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  horn_revelation: { file: 'audio/bgm/epic_landscape.mp3', volume: 0.45, loop: true },
  horse_hoof_distant: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  imperial_pressure: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  imzad_farewell: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  labor_rhythm: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  lively_cafeteria: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  lofi_beats: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  lonely_evening_strings: { file: 'audio/bgm/melancholic.mp3', volume: 0.35, loop: true },
  low_freq_tension: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  market_hum: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  market_tension: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  master_legacy: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  maternal_warmth: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  maternal_worry: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  memory_crack: { file: 'audio/bgm/bittersweet.mp3', volume: 0.35, loop: true },
  midnight_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  minimal_piano_night: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  minimal_piano_sparse: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  modern_traveller: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  morning_ambient_quiet: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  morning_calm_morin_khuur: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  morning_gentle_strings: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  ...
  mourning_wind: { file: 'audio/bgm/melancholic.mp3', volume: 0.35, loop: true },
  museum_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  night_calm_connection: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  night_city_calm: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  night_depot_hum: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  night_gentle: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  night_mission: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  night_rain_peace: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  night_rhythm: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  night_warmth: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  nile_dawn_chant: { file: 'audio/bgm/hopeful_rise.mp3', volume: 0.35, loop: true },
  nostalgic_tears: { file: 'audio/bgm/melancholic.mp3', volume: 0.35, loop: true },
  oasis_celebration: { file: 'audio/bgm/epic_landscape.mp3', volume: 0.45, loop: true },
  office_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  oil_lamp_solitude: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  operating_room_monitor_beep: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  panic_pulse: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  peaceful_ambient: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  pencil_on_paper_rhythm: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  phone_call_wind_pause: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  piano_nostalgia: { file: 'audio/bgm/bittersweet.mp3', volume: 0.35, loop: true },
  piano_revelation: { file: 'audio/bgm/emotional_buildup.mp3', volume: 0.4, loop: true },
  pipa_tree_guitar_strum: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  playful_morning: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  playful_quirk: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  playful_strings: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  precision_rhythm: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  quiet_keyboard_rhythm: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  quiet_piano: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  quiet_reflection: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  quipu_teaching: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  rain_sounds: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  rain_walk: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  rain_white_noise: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  rainy_morning_guqin: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  rainy_night_rescue_drone: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  reconciliation_piano: { file: 'audio/bgm/bittersweet.mp3', volume: 0.35, loop: true },
  reed_pen_whisper: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  restaurant_noise: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  return_gentle: { file: 'audio/bgm/emotional_buildup.mp3', volume: 0.4, loop: true },
  rhythmic_sorting_asmr: { file: 'audio/bgm/focused_rhythm.mp3', volume: 0.35, loop: true },
  ritual_chant: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  sacred_anxiety: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  scholar_debate: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  sean_nos_fire: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  seismic_pulse: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  self_reflection: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  signature_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  silence_to_strings: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  silence_wind: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  silent_breathing: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  silent_embrace: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  social_anxiety_invite: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  somber_folk: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  starry_night_reconciliation: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  steam_hiss: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  stethoscope_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  store_night: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  storm_drums: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  sunset_seal: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  sunset_walk: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  suspense_piano: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  tense_drum: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  tension: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  tension_afternoon: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  tension_night: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  tension_pluck: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  tension_release: { file: 'audio/bgm/tense_buildup.mp3', volume: 0.45, loop: true },
  tin_whistle_morning: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  triumphant_brass: { file: 'audio/bgm/epic_landscape.mp3', volume: 0.45, loop: true },
  truth_moment: { file: 'audio/bgm/emotional_buildup.mp3', volume: 0.4, loop: true },
  urban_transit_tense: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
  village_arrival_nostalgia: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  village_peace: { file: 'audio/bgm/gentle_folk.mp3', volume: 0.3, loop: true },
  warm_community: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  warm_community_guitar: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  warm_strings_hopeful: { file: 'audio/bgm/warm_resolution.mp3', volume: 0.35, loop: true },
  water_echo_ambient: { file: 'audio/bgm/gentle_acoustic.mp3', volume: 0.3, loop: true },
  wind_silence: { file: 'audio/bgm/somber_piano.mp3', volume: 0.3, loop: true },
